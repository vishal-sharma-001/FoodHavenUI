...
const Signup = ({ isOpen, onClose }) => {
  ...
  const handleOnClick = async (e) => {
    const url = isSignup ? `/public/user/signup` : `/public/user/login`;
    ...
    >
      ...
      >
        ...
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
          {formFields?.map(
            ({ label, type, name, placeholder, show = true }) =>
              show && (
                <div key={name}>
                  <label
                    htmlFor={name}
                  ...
                  <input
                    ...
                    required
                    className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 bg-gray-100 text-gray-700"

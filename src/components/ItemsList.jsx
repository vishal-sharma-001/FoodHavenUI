    ...
    return (
        <>
            <div className="flex justify-between p-3">
                ...
                <div>
                    <img className="rounded-md w-[150px] h-[150px]" src={BUCKET_PATH + prop?.cloudimageid + ".avif"} alt="Food Item" />
                    <button className="bg-white text-green-900 rounded-xl border-2 w-24 h-10 relative bottom-6">
                        {cartItem ? (
                            <div className="p-2 flex justify-between text-green-900">
                                <FaMinus onClick={() => decreaseQuantity(prop?.id)} className="pr-1" />
                    ...
                    <p className="font-light text-xs relative bottom-5 text-gray-500">Customisable</p>
                </div>
            </div>
            <hr />
        </>

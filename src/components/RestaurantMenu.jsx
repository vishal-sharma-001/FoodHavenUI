...
const RestaurantMenu = () => {
  ...
  if (data == null || restaurant == null) return <></>;
        ...
        <div className="fixed w-full h-full bg-black bg-opacity-40 flex justify-center items-center z-50 top-0 left-0">
          <div className="bg-white p-6 rounded-lg shadow-md max-w-md w-full text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">
              ...
              to reset your cart to add items from this restaurant?
            </p>
            <div className="flex justify-around">
              <button
                className="border border-black text-black py-2 px-4 rounded-md font-semibold hover:bg-neutral-200"
                onClick={() => dispatch(showClearCartModal(false))}
              >
                NO
              </button>
              <button
                className="bg-black text-white py-2 px-4 rounded-md font-semibold hover:bg-neutral-800"
                onClick={() => handleClearCardClick()}
              >
                YES, CLEAR CART
              </button>
            </div>
...
export const RestaurantCategory = ({
  ...
  return (
    <div>
      <div
        className="border-solid border-2 shadow-lg my-4 p-3 flex justify-between cursor-pointer"

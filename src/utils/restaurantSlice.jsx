...
const restaurantSlice = createSlice({
  ...
  reducers: {
    ...
    toggleFilter: (state, action) => {
      ...
      state.filteredRestaurantsList = applyFilters(
...
const applyFilters = (res, filters) => {
  return res.filter((restaurant) => {
    ...
    if (filters.priceRangelessThan300 && restaurant.costfortwo >= 300)
      return false;
    if (
      filters.priceRange300To600 &&
      (restaurant.costfortwo < 300 || restaurant.costfortwo > 600)
    )
      return false;
